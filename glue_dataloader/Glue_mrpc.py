...
class Train_mrpc(Dataset):
    def __init__(self, dataset_name, x_name, y_name, percentage=None):
        ...
        if percentage is None:
            ...
            train_data = load_dataset('glue', 'mrpc', split=f'train[:{percentage}%]')
...
class Val_mrpc(Dataset):
    def __init__(self, dataset_name, x_name, y_name, percentage=None):
        ...
        if percentage is None:
            ...
            val_data = load_dataset('glue', 'mrpc', split=f'validation[:{percentage}%]')
...
class Test_mrpc(Dataset):
    def __init__(self, dataset_name, x_name, y_name, percentage=None):
        ...
        if percentage is None:
            ...
            test_data = load_dataset('glue', 'mrpc', split=f'test[:{percentage}%]')
...
class Total_mrpc(Dataset):
    def __init__(self, dataset_name, x_name, y_name, percentage=None):
        self.train_data = Train_mrpc(dataset_name, x_name, y_name, percentage)
        self.val_data = Val_mrpc(dataset_name, x_name, y_name, percentage)
        self.test_data = Test_mrpc(dataset_name, x_name, y_name, percentage)
