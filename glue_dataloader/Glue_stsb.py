...
class Train_stsb(Dataset):
    def __init__(self, dataset_name, x_name_1, x_name_2, y_name, percentage=None):
        ...
        if percentage is None:
            ...
            train_data = load_dataset('glue', 'stsb', split=f'train[:{percentage}%]')
...
class Val_stsb(Dataset):
    def __init__(self, dataset_name, x_name_1, x_name_2, y_name, percentage=None):
        ...
        if percentage is None:
            ...
            val_data = load_dataset('glue', 'stsb', split=f'validation[:{percentage}%]')
...
class Test_stsb(Dataset):
    def __init__(self, dataset_name, x_name_1, x_name_2, y_name, percentage=None):
        ...
        if percentage is None:
            ...
            test_data = load_dataset('glue', 'stsb', split=f'test[:{percentage}%]')
...
class Total_stsb(Dataset):
    def __init__(self, dataset_name, x_name_1, x_name_2, y_name, percentage=None):
        self.train_data = Train_stsb(dataset_name, x_name_1, x_name_2, y_name, percentage)
        self.val_data = Val_stsb(dataset_name, x_name_1, x_name_2, y_name, percentage)
        self.test_data = Test_stsb(dataset_name, x_name_1, x_name_2, y_name, percentage)
